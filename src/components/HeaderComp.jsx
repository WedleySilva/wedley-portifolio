  ...
  <header className='headerComp' id="home">
    ...
    <div className="headerCenter">
      ...
      <div className="iconsHeaderMobile">
        <a href="https://github.com/wedleysilva" className="githubIconMobile" target="_blank" rel="noopener noreferrer">
          <FaGithub />
        </a>
        <a href="https://www.linkedin.com/in/wedley-silva-schmoeller-809104247/" className="linkedinIconMobile" target="_blank" rel="noopener noreferrer">
          <FaLinkedin />
        </a>
        <a href="mailto:wedleysilva21052gmail.com" className="mailIconMobile">
          <MdEmail />
        </a>
      </div>
    </div>
